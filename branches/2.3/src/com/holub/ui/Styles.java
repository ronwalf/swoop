...
/** This interface is a container of constants that your controls should
 * use to look similar to other controls. Implement the interface to get
 * access.
 *
 * <!-- ====================== distribution terms ===================== -->
 * <p><blockquote
...
{	/** Color used for standard text */
	static final Color NORMAL_COLOR 	= Color.BLACK;

	/** Color used for text highlighted because of an error */
