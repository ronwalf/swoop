 ...
 *
 */
public class PopupAddForeignOntology extends JDialog implements ActionListener, ItemListener {
	...
	public PopupAddForeignOntology(SwoopModel swoopModel) {
	    setModal(true);
	...
	private void setupUI() {
		...
		addOntBtn = new JButton("Add Foreign Ontology");
		...
		JLabel typeLbl = new JLabel("[ ADDING FOREIGN ONTOLOGY]");
	...
	private void fillValues() {
    	...
    	//ontCombo.addItem("/User-specified term or URI");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource()==addOntBtn) {
			...
			//TODO: swoopModel.addOntologyChanges(change);
			// dispose();
		}
