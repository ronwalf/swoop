...
public class XPointers {
	...
	// define all Swoop specific XPointers here
	
	// xpointer to handle display with imports: entity:asDefinedIn(ontology)
	public static String asDefinedIn = ":asDefinedIn"; 
